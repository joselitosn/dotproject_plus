            ...
            <td align="left">
                ...
                (<a href="index.php?m=contacts&a=addedit&contact_id=<?php echo $contact_id ?>" target="_blank">Acessar contato</a>)
                        ...
                        <tr>
                            ...
                            <td align='left'><input type='text' size="100" maxlength="500" name="human_resource_lattes_url" value="<?php echo dPformSafe($hr->human_resource_lattes_url); ?>" />
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr><td align='right'><?php echo $cwd_conv[0]; ?>:</td>
                            <td align='left'><input type='text' size="2" maxlength="5" name="human_resource_mon" value="<?php echo dPformSafe($hr->human_resource_mon); ?>" />
                            </td>
                        </tr>
                        ...
                        <tr><td align='right'><?php echo $cwd_conv[6]; ?>:</td>
                            <td align='left'><input type='text' size="2" maxlength="5" name="human_resource_sun" value="<?php echo dPformSafe($hr->human_resource_sun); ?>" />
                            </td></tr>	
                        <tr>
