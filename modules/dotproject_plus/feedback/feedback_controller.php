...
if (isset($_SESSION['AppUI']) && !isset($_SESSION["user_feedback_read"])) {
    ...
    $_SESSION["user_especific_feedback"] = isset($_COOKIE["user_especific_feedback"])?$_COOKIE["user_especific_feedback"]:1;
    $_SESSION["user_generic_feedback"] = isset($_COOKIE["user_generic_feedback"])?$_COOKIE["user_generic_feedback"]:1;
}
...
class InstructionalFeebackManager {
    ...
    private function initializeFeedbackMessages() {
        ...
        global $AppUI;
        $feedback_list[0] = new Feedback(0, "", "", true, "",false); //dummy feedback, just to fill index 0
        //The last feedback index is: 46 - update this comment accordingly new feedback messages are added.

        /* Integração */
        $feedback_list[1] = new Feedback(1, $AppUI->_("LBL_FEEDBACK_SHORT_1"), $AppUI->_("LBL_FEEDBACK_DESCRIPTION_1", UI_OUTPUT_HTML), true, $AppUI->_("LBL_FEEDBACK_INTEGRATION"),true);
        $feedback_list[1]->setDescriptionForAssignment($AppUI->_("LBL_FEEDBACK_EVALUATION_1"));
        $feedback_list[2] = new Feedback(2, $AppUI->_("LBL_FEEDBACK_SHORT_2"), $AppUI->_("LBL_FEEDBACK_DESCRIPTION_2", UI_OUTPUT_HTML), false, $AppUI->_("LBL_FEEDBACK_INTEGRATION"),false);
        $feedback_list[2]->setDescriptionForAssignment($AppUI->_("LBL_FEEDBACK_EVALUATION_2"));
        $feedback_list[3] = new Feedback(3, $AppUI->_("LBL_FEEDBACK_SHORT_3"), $AppUI->_("LBL_FEEDBACK_DESCRIPTION_3", UI_OUTPUT_HTML), true, $AppUI->_("LBL_FEEDBACK_INTEGRATION"),true);
        $feedback_list[3]->setDescriptionForAssignment($AppUI->_("LBL_FEEDBACK_EVALUATION_3"));  
        /* Escopo */
        $feedback_list[4] = new Feedback(4, $AppUI->_("LBL_FEEDBACK_SHORT_4"), $AppUI->_("LBL_FEEDBACK_DESCRIPTION_4", UI_OUTPUT_HTML), true, $AppUI->_("LBL_FEEDBACK_SCOPE"),false);
        $feedback_list[4]->setDescriptionForAssignment($AppUI->_("LBL_FEEDBACK_EVALUATION_4"));
        $feedback_list[5] = new Feedback(5, $AppUI->_("LBL_FEEDBACK_SHORT_5"), $AppUI->_("LBL_FEEDBACK_DESCRIPTION_5", UI_OUTPUT_HTML), true, $AppUI->_("LBL_FEEDBACK_SCOPE"),true);
        $feedback_list[5]->setDescriptionForAssignment($AppUI->_("LBL_FEEDBACK_EVALUATION_5"));   
        $feedback_list[6] = new Feedback(6, $AppUI->_("LBL_FEEDBACK_SHORT_6"), $AppUI->_("LBL_FEEDBACK_DESCRIPTION_6", UI_OUTPUT_HTML), true, $AppUI->_("LBL_FEEDBACK_SCOPE"),true);
        $feedback_list[6]->setDescriptionForAssignment($AppUI->_("LBL_FEEDBACK_EVALUATION_6"));
        $feedback_list[35] = new Feedback(35, $AppUI->_("LBL_FEEDBACK_SHORT_35"), $AppUI->_("LBL_FEEDBACK_DESCRIPTION_35", UI_OUTPUT_HTML), true, $AppUI->_("LBL_FEEDBACK_SCOPE"),false);
        $feedback_list[35]->setDescriptionForAssignment($AppUI->_("LBL_FEEDBACK_EVALUATION_35"));
        $feedback_list[37] = new Feedback(37, $AppUI->_("LBL_FEEDBACK_SHORT_37"), $AppUI->_("LBL_FEEDBACK_DESCRIPTION_37", UI_OUTPUT_HTML), false, $AppUI->_("LBL_FEEDBACK_SCOPE"),false);
...
//$feedback_list[7]= new Feedback(7, "Pacotes de trabalho não podem ser decompostos em novos items da EAP.","Você já está derivando as atividades do projeto dos pacotes de trabalho. Cuidado para não criar subitens da EAP para pacotes de trabalho que já tiveram atividades derivadas.",true,"Escopo");//será bloqueado a criação de pacotes de trabalho para items da EAP que já tem atividades //\modules\dotproject_plus\projects_tab.planning_and_monitoring.php
        /* Tempo */
        $feedback_list[8] = new Feedback(8, $AppUI->_("LBL_FEEDBACK_SHORT_8"), $AppUI->_("LBL_FEEDBACK_DESCRIPTION_8", UI_OUTPUT_HTML), true, $AppUI->_("LBL_FEEDBACK_TIME"),true);
        $feedback_list[8]->setDescriptionForAssignment($AppUI->_("LBL_FEEDBACK_EVALUATION_8"));
        $feedback_list[9] = new Feedback(9, $AppUI->_("LBL_FEEDBACK_SHORT_9"), $AppUI->_("LBL_FEEDBACK_DESCRIPTION_9", UI_OUTPUT_HTML), true, $AppUI->_("LBL_FEEDBACK_TIME"),true);
        $feedback_list[9]->setDescriptionForAssignment($AppUI->_("LBL_FEEDBACK_EVALUATION_9"));
        $feedback_list[10] = new Feedback(10, $AppUI->_("LBL_FEEDBACK_SHORT_10"), $AppUI->_("LBL_FEEDBACK_DESCRIPTION_10", UI_OUTPUT_HTML), false, $AppUI->_("LBL_FEEDBACK_TIME"),false);
        $feedback_list[10]->setDescriptionForAssignment($AppUI->_("LBL_FEEDBACK_EVALUATION_10"));
        $feedback_list[11] = new Feedback(11, $AppUI->_("LBL_FEEDBACK_SHORT_11"), $AppUI->_("LBL_FEEDBACK_DESCRIPTION_11", UI_OUTPUT_HTML), false, $AppUI->_("LBL_FEEDBACK_TIME"),true);
        $feedback_list[11]->setDescriptionForAssignment($AppUI->_("LBL_FEEDBACK_EVALUATION_11"));
        $feedback_list[12] = new Feedback(12, $AppUI->_("LBL_FEEDBACK_SHORT_12"), $AppUI->_("LBL_FEEDBACK_DESCRIPTION_12", UI_OUTPUT_HTML), false, $AppUI->_("LBL_FEEDBACK_TIME"), false);
        $feedback_list[12]->setDescriptionForAssignment($AppUI->_("LBL_FEEDBACK_EVALUATION_12"));
        $feedback_list[13] = new Feedback(13, $AppUI->_("LBL_FEEDBACK_SHORT_13"), $AppUI->_("LBL_FEEDBACK_DESCRIPTION_13", UI_OUTPUT_HTML), false, $AppUI->_("LBL_FEEDBACK_TIME"),true);
        $feedback_list[13]->setDescriptionForAssignment($AppUI->_("LBL_FEEDBACK_EVALUATION_13")); 
        $feedback_list[38] = new Feedback(38, $AppUI->_("LBL_FEEDBACK_SHORT_38"), $AppUI->_("LBL_FEEDBACK_DESCRIPTION_38", UI_OUTPUT_HTML), true, $AppUI->_("LBL_FEEDBACK_TIME"),true);
        //$feedback_list[38]->setDescriptionForAssignment($AppUI->_("LBL_FEEDBACK_EVALUATION_38"));
        $feedback_list[39] = new Feedback(39, $AppUI->_("LBL_FEEDBACK_SHORT_39"), $AppUI->_("LBL_FEEDBACK_DESCRIPTION_39", UI_OUTPUT_HTML), true, $AppUI->_("LBL_FEEDBACK_TIME"),true);
        //$feedback_list[39]->setDescriptionForAssignment($AppUI->_("LBL_FEEDBACK_EVALUATION_39"));
        /* Custo */
        $feedback_list[14] = new Feedback(14, $AppUI->_("LBL_FEEDBACK_SHORT_14"), $AppUI->_("LBL_FEEDBACK_DESCRIPTION_14", UI_OUTPUT_HTML), true, $AppUI->_("LBL_FEEDBACK_COST"),true);
        $feedback_list[14]->setDescriptionForAssignment($AppUI->_("LBL_FEEDBACK_EVALUATION_14"));
        $feedback_list[15] = new Feedback(15, $AppUI->_("LBL_FEEDBACK_SHORT_15"), $AppUI->_("LBL_FEEDBACK_DESCRIPTION_15", UI_OUTPUT_HTML), true, $AppUI->_("LBL_FEEDBACK_COST"),true);
        $feedback_list[15]->setDescriptionForAssignment($AppUI->_("LBL_FEEDBACK_EVALUATION_15"));
        $feedback_list[16] = new Feedback(16, $AppUI->_("LBL_FEEDBACK_SHORT_16"), $AppUI->_("LBL_FEEDBACK_DESCRIPTION_16", UI_OUTPUT_HTML), true, $AppUI->_("LBL_FEEDBACK_COST"),true);
        $feedback_list[16]->setDescriptionForAssignment($AppUI->_("LBL_FEEDBACK_EVALUATION_16"));
        $feedback_list[17] = new Feedback(17, $AppUI->_("LBL_FEEDBACK_SHORT_17"), $AppUI->_("LBL_FEEDBACK_DESCRIPTION_17", UI_OUTPUT_HTML), true, $AppUI->_("LBL_FEEDBACK_COST"),false);
        $feedback_list[17]->setDescriptionForAssignment($AppUI->_("LBL_FEEDBACK_EVALUATION_17"));
        $feedback_list[18] = new Feedback(18, $AppUI->_("LBL_FEEDBACK_SHORT_18"), $AppUI->_("LBL_FEEDBACK_DESCRIPTION_18", UI_OUTPUT_HTML), true, $AppUI->_("LBL_FEEDBACK_COST"),false);
        $feedback_list[18]->setDescriptionForAssignment($AppUI->_("LBL_FEEDBACK_EVALUATION_18")); 
        /* Qualidade */
        $feedback_list[19] = new Feedback(19, $AppUI->_("LBL_FEEDBACK_SHORT_19"), $AppUI->_("LBL_FEEDBACK_DESCRIPTION_19", UI_OUTPUT_HTML), false, $AppUI->_("LBL_FEEDBACK_QUALITY"),false);
        $feedback_list[19]->setDescriptionForAssignment($AppUI->_("LBL_FEEDBACK_EVALUATION_19"));
        $feedback_list[36] = new Feedback(36, $AppUI->_("LBL_FEEDBACK_SHORT_36"), $AppUI->_("LBL_FEEDBACK_DESCRIPTION_36", UI_OUTPUT_HTML), true, $AppUI->_("LBL_FEEDBACK_QUALITY"),false);
        $feedback_list[36]->setDescriptionForAssignment($AppUI->_("LBL_FEEDBACK_EVALUATION_36"));
        $feedback_list[40] = new Feedback(40, $AppUI->_("LBL_FEEDBACK_SHORT_40"), $AppUI->_("LBL_FEEDBACK_DESCRIPTION_40", UI_OUTPUT_HTML), true, $AppUI->_("LBL_FEEDBACK_QUALITY"),true);
        $feedback_list[40]->setDescriptionForAssignment($AppUI->_("LBL_FEEDBACK_EVALUATION_40"));
        /* Recursos Humanos */
        $feedback_list[20] = new Feedback(20, $AppUI->_("LBL_FEEDBACK_SHORT_20"), $AppUI->_("LBL_FEEDBACK_DESCRIPTION_20", UI_OUTPUT_HTML), true, $AppUI->_("LBL_FEEDBACK_HR"),false);
        $feedback_list[20]->setDescriptionForAssignment($AppUI->_("LBL_FEEDBACK_EVALUATION_20"));
        $feedback_list[21] = new Feedback(21, $AppUI->_("LBL_FEEDBACK_SHORT_21"), $AppUI->_("LBL_FEEDBACK_DESCRIPTION_21", UI_OUTPUT_HTML), true, $AppUI->_("LBL_FEEDBACK_HR"),true);
        $feedback_list[21]->setDescriptionForAssignment($AppUI->_("LBL_FEEDBACK_EVALUATION_21"));
        $feedback_list[22] = new Feedback(22, $AppUI->_("LBL_FEEDBACK_SHORT_22"), $AppUI->_("LBL_FEEDBACK_DESCRIPTION_22", UI_OUTPUT_HTML), false, $AppUI->_("LBL_FEEDBACK_HR"),false);
        $feedback_list[22]->setDescriptionForAssignment($AppUI->_("LBL_FEEDBACK_EVALUATION_22"));
        $feedback_list[41] = new Feedback(41, $AppUI->_("LBL_FEEDBACK_SHORT_41"), $AppUI->_("LBL_FEEDBACK_DESCRIPTION_41", UI_OUTPUT_HTML), true, $AppUI->_("LBL_FEEDBACK_HR"),true);
        $feedback_list[41]->setDescriptionForAssignment($AppUI->_("LBL_FEEDBACK_EVALUATION_41"));
        /* Comunicação */
        $feedback_list[23] = new Feedback(23, $AppUI->_("LBL_FEEDBACK_SHORT_23"), $AppUI->_("LBL_FEEDBACK_DESCRIPTION_23", UI_OUTPUT_HTML), true, $AppUI->_("LBL_FEEDBACK_COMUNICATION"),false);
        $feedback_list[23]->setDescriptionForAssignment($AppUI->_("LBL_FEEDBACK_EVALUATION_23"));
        $feedback_list[24] = new Feedback(24, $AppUI->_("LBL_FEEDBACK_SHORT_24"), $AppUI->_("LBL_FEEDBACK_DESCRIPTION_24", UI_OUTPUT_HTML), false, $AppUI->_("LBL_FEEDBACK_COMUNICATION"),false);
        $feedback_list[24]->setDescriptionForAssignment($AppUI->_("LBL_FEEDBACK_EVALUATION_24"));
        $feedback_list[25] = new Feedback(25, $AppUI->_("LBL_FEEDBACK_SHORT_25"), $AppUI->_("LBL_FEEDBACK_DESCRIPTION_25", UI_OUTPUT_HTML), false, $AppUI->_("LBL_FEEDBACK_COMUNICATION"),false);
        $feedback_list[25]->setDescriptionForAssignment($AppUI->_("LBL_FEEDBACK_EVALUATION_25"));
        $feedback_list[42] = new Feedback(42, $AppUI->_("LBL_FEEDBACK_SHORT_42"), $AppUI->_("LBL_FEEDBACK_DESCRIPTION_42", UI_OUTPUT_HTML), false, $AppUI->_("LBL_FEEDBACK_COMUNICATION"),false);
        $feedback_list[42]->setDescriptionForAssignment($AppUI->_("LBL_FEEDBACK_EVALUATION_42"));
        /* Riscos */
        $feedback_list[26] = new Feedback(26, $AppUI->_("LBL_FEEDBACK_SHORT_26"), $AppUI->_("LBL_FEEDBACK_DESCRIPTION_26", UI_OUTPUT_HTML), true, $AppUI->_("LBL_FEEDBACK_RISK"),true);
        $feedback_list[26]->setDescriptionForAssignment($AppUI->_("LBL_FEEDBACK_EVALUATION_26"));
        $feedback_list[27] = new Feedback(27, $AppUI->_("LBL_FEEDBACK_SHORT_27"), $AppUI->_("LBL_FEEDBACK_DESCRIPTION_27", UI_OUTPUT_HTML), true, $AppUI->_("LBL_FEEDBACK_RISK"),true);
        $feedback_list[27]->setDescriptionForAssignment($AppUI->_("LBL_FEEDBACK_EVALUATION_27"));
        $feedback_list[28] = new Feedback(28, $AppUI->_("LBL_FEEDBACK_SHORT_28"), $AppUI->_("LBL_FEEDBACK_DESCRIPTION_28", UI_OUTPUT_HTML), false, $AppUI->_("LBL_FEEDBACK_RISK"),true);
        ...
        $feedback_list[43] = new Feedback(43, $AppUI->_("LBL_FEEDBACK_SHORT_43"), $AppUI->_("LBL_FEEDBACK_DESCRIPTION_43", UI_OUTPUT_HTML), true, $AppUI->_("LBL_FEEDBACK_RISK"),true);
        $feedback_list[43]->setDescriptionForAssignment($AppUI->_("LBL_FEEDBACK_EVALUATION_43"));
        /* Aquisição */
        $feedback_list[29] = new Feedback(29, $AppUI->_("LBL_FEEDBACK_SHORT_29"), $AppUI->_("LBL_FEEDBACK_DESCRIPTION_29", UI_OUTPUT_HTML), true, $AppUI->_("LBL_FEEDBACK_ACQUISITIONS"),false);
        $feedback_list[29]->setDescriptionForAssignment($AppUI->_("LBL_FEEDBACK_EVALUATION_29"));
        $feedback_list[30] = new Feedback(30, $AppUI->_("LBL_FEEDBACK_SHORT_30"), $AppUI->_("LBL_FEEDBACK_DESCRIPTION_30", UI_OUTPUT_HTML), false, $AppUI->_("LBL_FEEDBACK_ACQUISITIONS"),false);
        $feedback_list[30]->setDescriptionForAssignment($AppUI->_("LBL_FEEDBACK_EVALUATION_30"));
        $feedback_list[44] = new Feedback(44, $AppUI->_("LBL_FEEDBACK_SHORT_44"), $AppUI->_("LBL_FEEDBACK_DESCRIPTION_44", UI_OUTPUT_HTML), true, $AppUI->_("LBL_FEEDBACK_ACQUISITIONS"),true);
        $feedback_list[44]->setDescriptionForAssignment($AppUI->_("LBL_FEEDBACK_EVALUATION_44"));
        $feedback_list[45] = new Feedback(45, $AppUI->_("LBL_FEEDBACK_SHORT_45"), $AppUI->_("LBL_FEEDBACK_DESCRIPTION_45", UI_OUTPUT_HTML), true, $AppUI->_("LBL_FEEDBACK_ACQUISITIONS"),false);
        $feedback_list[45]->setDescriptionForAssignment($AppUI->_("LBL_FEEDBACK_EVALUATION_45"));
        $feedback_list[46] = new Feedback(46, $AppUI->_("LBL_FEEDBACK_SHORT_46"), $AppUI->_("LBL_FEEDBACK_DESCRIPTION_46", UI_OUTPUT_HTML), true, $AppUI->_("LBL_FEEDBACK_ACQUISITIONS"),false);
        $feedback_list[46]->setDescriptionForAssignment($AppUI->_("LBL_FEEDBACK_EVALUATION_46"));
        /* Stakeholder */
        $feedback_list[31] = new Feedback(31, $AppUI->_("LBL_FEEDBACK_SHORT_31"), $AppUI->_("LBL_FEEDBACK_DESCRIPTION_31", UI_OUTPUT_HTML), true, "Stakeholder",true);
        $feedback_list[31]->setDescriptionForAssignment($AppUI->_("LBL_FEEDBACK_EVALUATION_31"));
        $feedback_list[32] = new Feedback(32, $AppUI->_("LBL_FEEDBACK_SHORT_32"), $AppUI->_("LBL_FEEDBACK_DESCRIPTION_32", UI_OUTPUT_HTML), true, "Stakeholder",false);
        $feedback_list[32]->setDescriptionForAssignment($AppUI->_("LBL_FEEDBACK_EVALUATION_32"));
        $feedback_list[33] = new Feedback(33, $AppUI->_("LBL_FEEDBACK_SHORT_33"), $AppUI->_("LBL_FEEDBACK_DESCRIPTION_33", UI_OUTPUT_HTML), false, "Stakeholder",false);
        $feedback_list[33]->setDescriptionForAssignment($AppUI->_("LBL_FEEDBACK_EVALUATION_33"));
    }
    

    public function formatMessagesForWord($obj){
        $message=$obj->getDescriptionForAssignment();    
        $format=!$obj->isTriggerDeterministic() ? array('italic'=>'true', 'color'=>'006699'): array();
        $_SESSION["cell"]->addText(utf8_decode($message), $format);  
        //$_SESSION["cell"]->addTextBreak(1);
    }
...
//20, 21, 41 -hr
                ...
                if (thereIsNonAllocatedRoles($projectId)) {
...
//26, 27, 28, 43 - risks
            ...
            if (thereIsRiskStrategyEliminateSomeResponse($projectId)) {
                $this->addFeedbackToUser($feedback_list[26]);
            }
            if (thereIsRiskStrategyAcceptWithPreventionPlan($projectId)) {
...
//29 e 30
            ...
            if ($procurementsCount > 1 && $procurementsCount <=3) {
    ...
    public function getEvaluationMessagesPerKA($KAKey) {
        ...
        foreach ($feedbacksPerKA as $feedbackKA) {
            if ($feedbackKA->getIsForAssignment() && $feedbackKA->getIsTriggerFiredForCurrentUser()) {
                $output.=($this->formatMessagesForWord($feedbackKA)). " ; ";//; ;utf8_encode(utf8_decode.          
            }
        }
...
function thereIsNonAllocatedHRs($projectId) {
    ...
    $q->addJoin("tasks", "t", "t.task_id=er.task_id", "left");
    $q->addWhere("u.user_company=" . $company_id . " and er.task_id is NULL and t.task_project=$projectId  and ucase(u.user_username) not like 'GRUP%'");
...
function thereIsNonConfiguredHR($projectId) {
    ...
    $query->addWhere("c.contact_company = " . $company_id . "  and hrc.cost_value is NULL and not ucase(u.user_username) like '%GRUP%' ");
    $sql = $query->prepare();
    $records = db_loadList($sql);
    if (count($records) > 0) {
        return true;
...
function thereIsRiskStrategyEliminateSomeResponse($projectId) {
    $q = new DBQuery();
    $q->addQuery('risk_id');
    $q->addTable('risks', 'r');
    $q->addWhere("risk_project = " . $projectId . " and risk_strategy=1 and (risk_prevention_actions <> '' or risk_contingency_plan <> '') ");
    $sql = $q->prepare();
    $records = db_loadList($sql);
    if (count($records) > 0) {
        return true;
...
function thereIsRiskStrategyAcceptWithPreventionPlan($projectId) {
    $q = new DBQuery();
    $q->addQuery('risk_id');
    $q->addTable('risks', 'r');
    $q->addWhere("risk_project = " . $projectId . " and risk_strategy=0 and risk_prevention_actions <> ''");
    $sql = $q->prepare();
    $records = db_loadList($sql);
    if (count($records) > 0) {
        return true;
