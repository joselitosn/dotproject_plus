...
if (sizeof($_SESSION["user_feedback"]) > 0){ 
    ?>
        ...
        <ul>
            <li class='active has-sub'>
                <u style="text-decoration: none">
                    <img style="cursor:pointer" src="./style/dotproject_plus/img/bell_icon.png" width="31" height="31" /> 
                    <div style="display:inline-block;position: relative;left:-16px;top: -6px; background-color: red;color:#FFFFFF; border-radius: 25px;">&nbsp;<?php echo sizeof($_SESSION["user_feedback"]); ?>&nbsp;</div>
                </u>
                <ul>
                    ...
                    <form method="post" action="?m=dotproject_plus" name="feedback_preferences">
                        ...
                        <!--
                        <input type="radio" value="1" name="generic_feedback" onclick="document.feedback_preferences.submit()" <?php echo $_SESSION["user_generic_feedback"] == 1 ? "checked" : "" ?> /><?php echo $AppUI->_("LBL_YES"); ?>
                        <input type="radio" value="0" name="generic_feedback" onclick="document.feedback_preferences.submit()" <?php echo $_SESSION["user_generic_feedback"] == 0 ? "checked" : "" ?> /><?php echo $AppUI->_("LBL_NO"); ?>
                        -->
                       ...
                       <!--
                        <input type="radio" value="1" name="especific_feedback" onclick="document.feedback_preferences.submit()" <?php echo $_SESSION["user_especific_feedback"] == 1 ? "checked" : "" ?> /><?php echo $AppUI->_("LBL_YES"); ?>
                        <input type="radio" value="0" name="especific_feedback" onclick="document.feedback_preferences.submit()" <?php echo $_SESSION["user_especific_feedback"] == 0 ? "checked" : "" ?> /><?php echo $AppUI->_("LBL_NO"); ?>
                        -->
                           <div class="onoffswitch" >
                                ...
                                <li>
                                    <a  style="line-height: 120%" href="#" onclick="document.getElementById('show_feedback_<?php echo $feedback->getId() ?>').submit()">
                                        <form name="show_feedback_<?php echo $feedback->getId() ?>" id="show_feedback_<?php echo $feedback->getId() ?>" method="post" action="?m=dotproject_plus">
                                            <img src="./style/dotproject_plus/img/feedback/<?php echo getIconByKnowledgeArea($feedback->getKnowledgeArea()) ?>.png" style="width:20px; height: 20px" />
